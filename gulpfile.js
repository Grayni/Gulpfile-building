...
/* Description: build gulpfile.js for development sites with use
	 different libs and frameworks.
	 Functions: unites, 
	 Have two browser-servers, but need install lamp or other localhost.
	 Then first 'localhost' must input in [app] - root-dir.
	 Second 'localhost2' must input in [dist] - root-dir.
...
// compare js files in one file and minify it
